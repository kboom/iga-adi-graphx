...
import edu.agh.kboom.iga.adi.graph.solver.core.MatrixX
import edu.agh.kboom.iga.adi.graph.solver.core.tree.{InterimVertex, RootVertex}
import edu.agh.kboom.{DummyProblem, ElementUtils, MatrixColors, SubjectSpec}
