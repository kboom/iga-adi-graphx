...
import edu.agh.kboom.iga.adi.graph.core.tree.ProblemTree.lastIndexOfLeafRow
import edu.agh.kboom.iga.adi.graph.core.tree.Vertex.{childIndicesOf, vertexOf}
import edu.agh.kboom.iga.adi.graph.core.tree.{ProblemTree, Vertex}
