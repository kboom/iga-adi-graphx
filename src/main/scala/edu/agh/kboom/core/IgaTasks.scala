...
import edu.agh.kboom.core.tree.ProblemTree.lastIndexOfLeafRow
import edu.agh.kboom.core.tree.Vertex.{childIndicesOf, vertexOf}
import edu.agh.kboom.core.tree.{ProblemTree, Vertex}
