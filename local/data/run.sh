...
spark-submit \
    ...
    --driver-java-options "-Dproblem.size=768 -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=5005 -XX:+UseCompressedOops -Dproblem.steps=1 -XX:+UseG1GC -XX:+UnlockExperimentalVMOptions -XX:+UseStringDeduplication -XX:InitiatingHeapOccupancyPercent=0 -XX:MaxGCPauseMillis=200 -XX:ParallelGCThreads=8 -XX:ConcGCThreads=8 -XX:G1ReservePercent=10 -XX:G1HeapRegionSize=8m" \
    ${@} \
